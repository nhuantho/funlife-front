...
const Test = () => {
  ...
  const API = "https://funlife.azurewebsites.net/getByCodeSetOfQuestions/KSDV"
  ...
  const postApiUQA = () => {
    ...
    for(let i=0; i<test.length; i++){
      d.push({"userName":user[0].userName, "codeQuestion":test[i].question.code, "codeAnswer":test[i].answer.code, "date":date})
    }
    // console.log(data);
    axios({
      method: 'post',
